...
public class KeyStore {
    ...
    public static KeyStoreFile createStandard(String password, byte[] privateKey,String address)
            throws CipherException {
        return create(password, privateKey,address, N_STANDARD, P_STANDARD);
    }
    public static KeyStoreFile createLight(String password, byte[] privateKey,String address)
            throws CipherException {
        return create(password, privateKey,address, N_LIGHT, P_LIGHT);
    }
    public static KeyStoreFile create(String password, byte[] privateKey,String address, int n, int p)
            throws CipherException {
    ...
    private static KeyStoreFile createWalletFile(String address,byte[] cipherText, byte[] iv, byte[] salt, byte[] mac,
            int n, int p) {
    ...
    public static byte[] decrypt(String password, KeyStoreFile walletFile)
